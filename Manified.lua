...
function Library:CreateUi()
    ...
    function self:CreateTab(title: string, icon: string)
        ...
        params.Text = title
        params.Font = Font.new('rbxasset://fonts/families/GothamSSm.json')
        params.Size = 13
        params.Width = 10000
        ...
        function TabManager:CreateModule(settings: any)
            ...
            function ModuleManager:CreateSlider(settings: any)
                ...
                if Library:flag_type(settings.Flag, 'number') then
                    SliderManager:set_percentage(Library._config._flags[settings.Flag] or settings.Default)
                else
                    SliderManager:set_percentage(settings.Default or settings.Min)
                end
